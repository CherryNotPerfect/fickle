; Boilerplate code for fickle.py 
...
;--- This is what fickle.py will generate for us - encoded command
;-- CUT HERE -----------
  push 0x11113a38
  push 0x4284813f
  push 0x85847685
